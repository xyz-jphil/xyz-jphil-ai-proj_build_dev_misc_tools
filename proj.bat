...
rem set AOT_CACHE=%USERPROFILE%\xyz-jphil\ai\proj-build_dev_misc_tools\AOTCache.aot
set AOT_CACHE=%usrp%\code\xyz-jphil\xyz-jphil-ai-proj_build_dev_misc_tools\target\AOTCache.aot 
